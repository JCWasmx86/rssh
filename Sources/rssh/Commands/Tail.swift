...
struct Tail: ParsableCommand, SSHCommand {
  static var configuration = CommandConfiguration(
    commandName: "tail", abstract: "Display the last part of a file")
  @Flag(
    name: [.customShort("F")],
    help:
  ...
  var f: Bool = false
  @Option(name: [.customShort("b")], help: "The location is number 512-byte blocks.")
  var b: Int?
  @Option(name: [.customShort("c")], help: "The location is number bytes.")
  var c: Int?
  @Option(name: [.customShort("n")], help: "The location is number lines.")
  var n: Int?
  @Flag(
    name: [.customShort("q")],
