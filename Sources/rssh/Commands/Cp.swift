...
struct Cp: ParsableCommand, SSHCommand {
  static var configuration = CommandConfiguration(commandName: "cp", abstract: "Copy files")
  @Flag(
    name: [.customShort("H")],
    help:
  ...
  @Flag(name: [.customShort("a")], help: "Archive mode.  Same as -RpP.") var a: Bool = false
  @Flag(
    name: [.customShort("f")],
    help:
  ...
  @Flag(name: [.customShort("x")], help: "File system mount points are not traversed.") var x:
    Bool = false
