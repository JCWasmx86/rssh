...
struct Cat: ParsableCommand, SSHCommand {
  static var configuration = CommandConfiguration(
    commandName: "cat",
    abstract: "Concatenate files and print on the standard output"
  )
  @Flag(name: [.customShort("b")], help: "Number the non-blank output lines, starting at 1.") var b:
    Bool = false
  @Flag(
    name: [.customShort("e")],
    help:
  ...
  @Flag(name: [.customShort("n")], help: "Number the output lines, starting at 1.") var n: Bool =
    false
  @Flag(
    name: [.customShort("s")],
  ...
  @Flag(name: [.customShort("u")], help: "Disable output buffering.") var u: Bool = false
  @Flag(
    name: [.customShort("v")],
    help:
